...
class Server(models.Model):
    ...
    sub_asset_type = models.SmallIntegerField(choices=sub_asset_type_choices, verbose_name=u'服务器类型', default=3)
    create_by = models.CharField(choices=create_by_choices, max_length=32, default='auto')
    ...
    raid_type = models.CharField(u'raid类型', max_length=32, blank=True, null=True)
    os_type = models.CharField(u'操作系统类型', max_length=64, blank=True, null=True)
    os_distribution = models.CharField(u'操作系统发行版本', max_length=64, blank=True, null=True)
    os_release = models.CharField(u'操作系统版本', max_length=64, blank=True, null=True)
    resource_group = models.ForeignKey('ResourceGroup', verbose_name=u'资源组', blank=True, null=True,
                                       on_delete=models.CASCADE)
...
class Software(models.Model):
    ...
    license_num = models.IntegerField(verbose_name="授权数", blank=True, null=True)
...
class ResourceGroup(models.Model):
    name = models.CharField(u'所属资源组', max_length=128)
    def __str__(self):
        return self.name
    class Meta:
        verbose_name = '资源组'
        verbose_name_plural = "资源组"
